...
#ifndef _DW1000_RANGING_H_INCLUDED
#define _DW1000_RANGING_H_INCLUDED
...
class DW1000RangingClass {
  public:
    ...
    //initialisation
    static void initCommunication(unsigned int myRST=DEFAULT_RST_PIN, unsigned int mySS=DEFAULT_SPI_SS_PIN, unsigned int myIRQ=9);
